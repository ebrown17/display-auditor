...
public class RxJavaFXTest extends Application {
  ...
  public static void main(String... args) {
    ...
    Observable<Entry<String, ArrayList<Platforms.Platform>>> source2 = Observable.fromIterable(stations.entrySet());
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    JavaFxObservable.eventsOf(rectangle,MouseEvent.MOUSE_CLICKED)
            .map(me -> Color.ROYALBLUE)
            .subscribe(rectangle::setFill);
    
    JavaFxObservable.eventsOf(rectangle,MouseEvent.MOUSE_ENTERED)
    .map(me -> Color.ROYALBLUE)
    .subscribe(rectangle::setFill);
    
    JavaFxObservable.eventsOf(rectangle,MouseEvent.MOUSE_EXITED)
    .map(me -> Color.RED)
    .subscribe(rectangle::setFill);
    ...
    vBox.getChildren().addAll(countLabel,button,spinner,spinnerChangesLabel,listView,positionLabel,rectangle,label,input,button1);
