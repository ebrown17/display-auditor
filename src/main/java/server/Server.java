...
public class Server {
  ...
  private final Logger logger = LoggerFactory.getLogger("server.Server");

  public Server(InetSocketAddress socketAddress) {
    this.socketAddress = socketAddress;
  }

  public void configure(LinkedBlockingQueue<JdssAuditor.DisplayData> msgQueue) {
    ...
    bootstrap.childHandler(new ServerChannelInitializer(msgQueue));
